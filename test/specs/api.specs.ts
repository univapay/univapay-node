...
describe('API', function() {
    ...
    it('should send request with authorization header', async function() {
        ...
        const asserts: [object, object, string][] = [
            [{}, null, null],
    ...
    it('should update token if it comes back in the response', async function() {
        ...
        const asserts = [['header1', 'Authorization'], ['headerAmzn1', 'x-amzn-Remapped-Authorization']];
    ...
    it('should convert all params to underscore', async function() {
        ...
        const asserts = [{ foo: 'bar', fizz_buzz: true }, { foo: 'bar', fizzBuzz: true }];
    ...
    it('should return unknown error', async function() {
        ...
        expect(fromError(error))
            .to.be.instanceOf(ResponseError)
            .and.to.have.property('errorResponse')
            .that.eql({
                status: 'error',

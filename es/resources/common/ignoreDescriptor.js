...
export function ignoreDescriptor(callback, data) {
    return tslib_1.__awaiter(this, void 0, void 0, function () {
        ...
        return tslib_1.__generator(this, function (_a) {
            switch (_a.label) {
                ...
                case 2:
                    error_1 = _a.sent();
                    isDescriptorNotSupportedError = error_1.errorResponse.code === ResponseErrorCode.ValidationError &&
                        error_1.errorResponse.errors.length === 1 &&
                        error_1.errorResponse.errors.find(function (e) { return e.field === 'descriptor' && e.reason === ResponseErrorCode.NotSupportedByProcessor; });

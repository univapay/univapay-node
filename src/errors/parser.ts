...
export const getProcessingErrorCodeByStatus = (status: number, isThreeDsError?: boolean): string => {
    const codeMap: Record<number, string> = {
        301: isThreeDsError ? ResponseErrorCode.ThreeDSCardNumberNotValid : ResponseErrorCode.CardNumberNotValid,
        302: ResponseErrorCode.CardExpirationMonthInvalid,
        303: ResponseErrorCode.CardExpirationYearInvalid,
        304: isThreeDsError ? ResponseErrorCode.ThreeDSCardExpired : ResponseErrorCode.CardExpired,
        305: ResponseErrorCode.CardCVVInvalid,
        306: ResponseErrorCode.CardRejected,
        307: isThreeDsError ? ResponseErrorCode.ThreeDSCardInvalid : ResponseErrorCode.CardInvalid,
        ...
        314: isThreeDsError ? ResponseErrorCode.ThreeDsSeizeCard : ResponseErrorCode.SeizeCard,
        ...
        319: isThreeDsError ? ResponseErrorCode.ThreeDsFraudSuspected : ResponseErrorCode.FraudSuspected,
        ...
        327: isThreeDsError
            ? ResponseErrorCode.ThreeDsConfirmationPeriodExpired
        ...
        336: isThreeDsError
            ? ResponseErrorCode.ThreeDsLimitExceededForPaymentType
        ...
        343: isThreeDsError ? ResponseErrorCode.ThreeDSGatewayServerError : ResponseErrorCode.GatewayServerError,
        ...
        351: ResponseErrorCode.DisputedTransation,
        ...
        359: isThreeDsError ? ResponseErrorCode.ThreeDsCardRejected : ResponseErrorCode.CardRejected,
